...
create or replace view semiUp2277543237332152416 as select o_orderkey as v18, o_custkey as v1 from orders AS orders where (o_custkey) in (select v1 from semiUp654727505751686521) and o_orderdate>=DATE '1994-01-01' and o_orderdate < DATE '1994-01-01' + INTERVAL '1' YEAR;
