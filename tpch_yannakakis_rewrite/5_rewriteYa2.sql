create or replace view semiUp6352523796711007044 as select o_orderkey as v18, o_custkey as v1 from orders AS orders where (o_custkey) in (select c_custkey from customer AS customer) and o_orderdate>=DATE '1994-01-01' and o_orderdate < DATE '1994-01-01' + INTERVAL '1' YEAR;
...
create or replace view aggJoin3792860192234548407 as select v42, v49 from aggView3073379489580314981 where v4 = v51;
