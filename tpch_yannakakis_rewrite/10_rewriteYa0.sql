...
create or replace view semiUp7102525963518450131 as select o_orderkey as v18, o_custkey as v1 from orders AS orders where (o_custkey) in (select v1 from semiUp6714693642086752185) and o_orderdate>=DATE '1993-10-01' and o_orderdate < DATE '1993-10-01' + INTERVAL '3' MONTH;
