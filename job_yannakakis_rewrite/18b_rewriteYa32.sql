...
FROM ya_18b_rewriteYa32_down_ci AS ci,
     ya_18b_rewriteYa32_down_it1 AS it1,
     ya_18b_rewriteYa32_down_it2 AS it2,
     ya_18b_rewriteYa32_down_mi AS mi,
     ya_18b_rewriteYa32_down_mi_idx AS mi_idx,
     ya_18b_rewriteYa32_down_n AS n,
     ya_18b_rewriteYa32_down_t AS t
WHERE (ci.note IN ('(writer)',
                  '(head writer)',
                  '(written by)',
                  '(story)',
