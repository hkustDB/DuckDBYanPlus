...
CREATE OR REPLACE TEMP VIEW ya_15b_rewriteYa87_r3_base_akt AS
...
CREATE OR REPLACE TEMP VIEW ya_15b_rewriteYa87_r3_base_cn AS
SELECT cn.id AS cn__id,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_15b_rewriteYa87_down_cn AS cn
GROUP BY cn.id;

CREATE OR REPLACE TEMP VIEW ya_15b_rewriteYa87_r3_base_ct AS
SELECT ct.id AS ct__id,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_15b_rewriteYa87_down_ct AS ct
GROUP BY ct.id;

CREATE OR REPLACE TEMP VIEW ya_15b_rewriteYa87_r3_base_it1 AS
SELECT it1.id AS it1__id,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_15b_rewriteYa87_down_it1 AS it1
GROUP BY it1.id;

CREATE OR REPLACE TEMP VIEW ya_15b_rewriteYa87_r3_base_k AS
SELECT k.id AS k__id,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_15b_rewriteYa87_down_k AS k
GROUP BY k.id;

CREATE OR REPLACE TEMP VIEW ya_15b_rewriteYa87_r3_base_mc AS
SELECT mc.movie_id AS mc__movie_id,
       mc.company_id AS mc__company_id,
       mc.company_type_id AS mc__company_type_id,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_15b_rewriteYa87_down_mc AS mc
GROUP BY mc.movie_id, mc.company_id, mc.company_type_id;

CREATE OR REPLACE TEMP VIEW ya_15b_rewriteYa87_r3_base_mi AS
SELECT mi.movie_id AS mi__movie_id,
       mi.info_type_id AS mi__info_type_id,
       mi.info AS mi__info,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_15b_rewriteYa87_down_mi AS mi
GROUP BY mi.movie_id, mi.info_type_id, mi.info;

CREATE OR REPLACE TEMP VIEW ya_15b_rewriteYa87_r3_base_mk AS
SELECT mk.movie_id AS mk__movie_id,
       mk.keyword_id AS mk__keyword_id,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_15b_rewriteYa87_down_mk AS mk
GROUP BY mk.movie_id, mk.keyword_id;

CREATE OR REPLACE TEMP VIEW ya_15b_rewriteYa87_r3_base_t AS
SELECT t.id AS t__id,
       t.title AS t__title,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_15b_rewriteYa87_down_t AS t
GROUP BY t.id, t.title;

CREATE OR REPLACE TEMP VIEW ya_15b_rewriteYa87_r3_join_1 AS
SELECT round3_left.mk__movie_id AS mk__movie_id,
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_15b_rewriteYa87_r3_base_mk AS round3_left
JOIN ya_15b_rewriteYa87_r3_base_k AS round3_right
  ON (round3_right.k__id = round3_left.mk__keyword_id)
GROUP BY round3_left.mk__movie_id;

CREATE OR REPLACE TEMP VIEW ya_15b_rewriteYa87_r3_join_2 AS
SELECT round3_left.mi__info AS mi__info,
       ...
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_15b_rewriteYa87_r3_base_mi AS round3_left
JOIN ya_15b_rewriteYa87_r3_join_1 AS round3_right
  ON (round3_right.mk__movie_id = round3_left.mi__movie_id)
GROUP BY round3_left.mi__info, round3_left.mi__movie_id, round3_right.mk__movie_id, round3_left.mi__info_type_id;

CREATE OR REPLACE TEMP VIEW ya_15b_rewriteYa87_r3_join_3 AS
SELECT round3_left.mi__info AS mi__info,
       ...
       round3_left.mi__info_type_id AS mi__info_type_id,
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_15b_rewriteYa87_r3_join_2 AS round3_left
JOIN ya_15b_rewriteYa87_r3_base_t AS round3_right
  ON (round3_right.t__id = round3_left.mi__movie_id)
 AND (round3_right.t__id = round3_left.mk__movie_id)
GROUP BY round3_left.mi__info, round3_right.t__title, round3_right.t__id, round3_left.mk__movie_id, round3_left.mi__movie_id, round3_left.mi__info_type_id;

CREATE OR REPLACE TEMP VIEW ya_15b_rewriteYa87_r3_join_4 AS
SELECT round3_left.mi__info AS mi__info,
       ...
       round3_left.mi__info_type_id AS mi__info_type_id,
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_15b_rewriteYa87_r3_join_3 AS round3_left
JOIN ya_15b_rewriteYa87_r3_base_akt AS round3_right
...
GROUP BY round3_left.mi__info, round3_left.t__title, round3_left.t__id, round3_left.mk__movie_id, round3_left.mi__movie_id, round3_right.akt__movie_id, round3_left.mi__info_type_id;

CREATE OR REPLACE TEMP VIEW ya_15b_rewriteYa87_r3_join_5 AS
SELECT round3_left.mi__info AS mi__info,
       round3_left.t__title AS t__title,
       round3_left.t__id AS t__id,
       round3_left.mk__movie_id AS mk__movie_id,
       ...
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_15b_rewriteYa87_r3_join_4 AS round3_left
JOIN ya_15b_rewriteYa87_r3_base_it1 AS round3_right
  ON (round3_right.it1__id = round3_left.mi__info_type_id)
GROUP BY round3_left.mi__info, round3_left.t__title, round3_left.t__id, round3_left.mk__movie_id, round3_left.mi__movie_id, round3_left.akt__movie_id;

CREATE OR REPLACE TEMP VIEW ya_15b_rewriteYa87_r3_join_6 AS
SELECT round3_left.mc__movie_id AS mc__movie_id,
       round3_left.mc__company_type_id AS mc__company_type_id,
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_15b_rewriteYa87_r3_base_mc AS round3_left
JOIN ya_15b_rewriteYa87_r3_base_cn AS round3_right
  ON (round3_right.cn__id = round3_left.mc__company_id)
GROUP BY round3_left.mc__movie_id, round3_left.mc__company_type_id;

CREATE OR REPLACE TEMP VIEW ya_15b_rewriteYa87_r3_join_7 AS
SELECT round3_left.mc__movie_id AS mc__movie_id,
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_15b_rewriteYa87_r3_join_6 AS round3_left
JOIN ya_15b_rewriteYa87_r3_base_ct AS round3_right
  ON (round3_right.ct__id = round3_left.mc__company_type_id)
GROUP BY round3_left.mc__movie_id;

CREATE OR REPLACE TEMP VIEW ya_15b_rewriteYa87_r3_join_8 AS
SELECT round3_left.mi__info AS mi__info,
       round3_left.t__title AS t__title,
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_15b_rewriteYa87_r3_join_5 AS round3_left
JOIN ya_15b_rewriteYa87_r3_join_7 AS round3_right
...
FROM ya_15b_rewriteYa87_r3_join_8 AS round3_result;
