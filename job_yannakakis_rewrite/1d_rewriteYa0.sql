...
CREATE OR REPLACE TEMP VIEW ya_1d_rewriteYa0_r3_base_ct AS
SELECT ct.id AS ct__id,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_1d_rewriteYa0_down_ct AS ct
GROUP BY ct.id;

CREATE OR REPLACE TEMP VIEW ya_1d_rewriteYa0_r3_base_it AS
SELECT it.id AS it__id,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_1d_rewriteYa0_down_it AS it
GROUP BY it.id;

CREATE OR REPLACE TEMP VIEW ya_1d_rewriteYa0_r3_base_mc AS
SELECT mc.company_type_id AS mc__company_type_id,
       mc.movie_id AS mc__movie_id,
       mc.note AS mc__note,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_1d_rewriteYa0_down_mc AS mc
GROUP BY mc.company_type_id, mc.movie_id, mc.note;

CREATE OR REPLACE TEMP VIEW ya_1d_rewriteYa0_r3_base_mi_idx AS
SELECT mi_idx.movie_id AS mi_idx__movie_id,
       mi_idx.info_type_id AS mi_idx__info_type_id,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_1d_rewriteYa0_down_mi_idx AS mi_idx
GROUP BY mi_idx.movie_id, mi_idx.info_type_id;

CREATE OR REPLACE TEMP VIEW ya_1d_rewriteYa0_r3_base_t AS
SELECT t.id AS t__id,
       t.title AS t__title,
       t.production_year AS t__production_year,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_1d_rewriteYa0_down_t AS t
GROUP BY t.id, t.title, t.production_year;

CREATE OR REPLACE TEMP VIEW ya_1d_rewriteYa0_r3_join_1 AS
...
FROM ya_1d_rewriteYa0_r3_base_mc AS round3_left
JOIN ya_1d_rewriteYa0_r3_base_t AS round3_right
...
CREATE OR REPLACE TEMP VIEW ya_1d_rewriteYa0_r3_join_2 AS
SELECT round3_left.mi_idx__movie_id AS mi_idx__movie_id,
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_1d_rewriteYa0_r3_base_mi_idx AS round3_left
JOIN ya_1d_rewriteYa0_r3_base_it AS round3_right
  ON (round3_right.it__id = round3_left.mi_idx__info_type_id)
GROUP BY round3_left.mi_idx__movie_id;

CREATE OR REPLACE TEMP VIEW ya_1d_rewriteYa0_r3_join_3 AS
SELECT round3_left.mc__note AS mc__note,
       round3_left.t__title AS t__title,
       round3_left.t__production_year AS t__production_year,
       round3_left.mc__company_type_id AS mc__company_type_id,
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_1d_rewriteYa0_r3_join_1 AS round3_left
JOIN ya_1d_rewriteYa0_r3_join_2 AS round3_right
...
CREATE OR REPLACE TEMP VIEW ya_1d_rewriteYa0_r3_join_4 AS
SELECT round3_right.mc__note AS mc__note,
       round3_right.t__title AS t__title,
       round3_right.t__production_year AS t__production_year,
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_1d_rewriteYa0_r3_base_ct AS round3_left
JOIN ya_1d_rewriteYa0_r3_join_3 AS round3_right
...
FROM ya_1d_rewriteYa0_r3_join_4 AS round3_result;
