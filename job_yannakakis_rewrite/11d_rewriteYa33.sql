...
CREATE OR REPLACE TEMP VIEW ya_11d_rewriteYa33_r3_base_cn AS
...
CREATE OR REPLACE TEMP VIEW ya_11d_rewriteYa33_r3_base_ct AS
SELECT ct.id AS ct__id,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_11d_rewriteYa33_down_ct AS ct
GROUP BY ct.id;

CREATE OR REPLACE TEMP VIEW ya_11d_rewriteYa33_r3_base_k AS
SELECT k.id AS k__id,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_11d_rewriteYa33_down_k AS k
GROUP BY k.id;

CREATE OR REPLACE TEMP VIEW ya_11d_rewriteYa33_r3_base_lt AS
SELECT lt.id AS lt__id,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_11d_rewriteYa33_down_lt AS lt
GROUP BY lt.id;

CREATE OR REPLACE TEMP VIEW ya_11d_rewriteYa33_r3_base_mc AS
SELECT mc.movie_id AS mc__movie_id,
       mc.company_type_id AS mc__company_type_id,
       mc.company_id AS mc__company_id,
       mc.note AS mc__note,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_11d_rewriteYa33_down_mc AS mc
GROUP BY mc.movie_id, mc.company_type_id, mc.company_id, mc.note;

CREATE OR REPLACE TEMP VIEW ya_11d_rewriteYa33_r3_base_mk AS
SELECT mk.movie_id AS mk__movie_id,
       mk.keyword_id AS mk__keyword_id,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_11d_rewriteYa33_down_mk AS mk
GROUP BY mk.movie_id, mk.keyword_id;

CREATE OR REPLACE TEMP VIEW ya_11d_rewriteYa33_r3_base_ml AS
SELECT ml.link_type_id AS ml__link_type_id,
       ml.movie_id AS ml__movie_id,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_11d_rewriteYa33_down_ml AS ml
GROUP BY ml.link_type_id, ml.movie_id;

CREATE OR REPLACE TEMP VIEW ya_11d_rewriteYa33_r3_base_t AS
SELECT t.id AS t__id,
       t.title AS t__title,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_11d_rewriteYa33_down_t AS t
GROUP BY t.id, t.title;

CREATE OR REPLACE TEMP VIEW ya_11d_rewriteYa33_r3_join_1 AS
...
FROM ya_11d_rewriteYa33_r3_base_mc AS round3_left
JOIN ya_11d_rewriteYa33_r3_base_cn AS round3_right
...
CREATE OR REPLACE TEMP VIEW ya_11d_rewriteYa33_r3_join_2 AS
SELECT round3_left.mk__movie_id AS mk__movie_id,
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_11d_rewriteYa33_r3_base_mk AS round3_left
JOIN ya_11d_rewriteYa33_r3_base_k AS round3_right
  ON (round3_left.mk__keyword_id = round3_right.k__id)
GROUP BY round3_left.mk__movie_id;

CREATE OR REPLACE TEMP VIEW ya_11d_rewriteYa33_r3_join_3 AS
SELECT round3_left.cn__name AS cn__name,
       ...
       round3_left.mc__company_type_id AS mc__company_type_id,
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_11d_rewriteYa33_r3_join_1 AS round3_left
JOIN ya_11d_rewriteYa33_r3_join_2 AS round3_right
  ON (round3_right.mk__movie_id = round3_left.mc__movie_id)
GROUP BY round3_left.cn__name, round3_left.mc__note, round3_right.mk__movie_id, round3_left.mc__movie_id, round3_left.mc__company_type_id;

CREATE OR REPLACE TEMP VIEW ya_11d_rewriteYa33_r3_join_4 AS
SELECT round3_left.ml__movie_id AS ml__movie_id,
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_11d_rewriteYa33_r3_base_ml AS round3_left
JOIN ya_11d_rewriteYa33_r3_base_lt AS round3_right
  ON (round3_right.lt__id = round3_left.ml__link_type_id)
GROUP BY round3_left.ml__movie_id;

CREATE OR REPLACE TEMP VIEW ya_11d_rewriteYa33_r3_join_5 AS
SELECT round3_left.cn__name AS cn__name,
       round3_left.mc__note AS mc__note,
       ...
       round3_left.mc__company_type_id AS mc__company_type_id,
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_11d_rewriteYa33_r3_join_3 AS round3_left
JOIN ya_11d_rewriteYa33_r3_join_4 AS round3_right
  ON (round3_right.ml__movie_id = round3_left.mk__movie_id)
 AND (round3_right.ml__movie_id = round3_left.mc__movie_id)
GROUP BY round3_left.cn__name, round3_left.mc__note, round3_right.ml__movie_id, round3_left.mk__movie_id, round3_left.mc__movie_id, round3_left.mc__company_type_id;

CREATE OR REPLACE TEMP VIEW ya_11d_rewriteYa33_r3_join_6 AS
SELECT round3_left.cn__name AS cn__name,
       round3_left.mc__note AS mc__note,
       round3_right.t__title AS t__title,
       round3_left.mc__company_type_id AS mc__company_type_id,
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_11d_rewriteYa33_r3_join_5 AS round3_left
JOIN ya_11d_rewriteYa33_r3_base_t AS round3_right
...
GROUP BY round3_left.cn__name, round3_left.mc__note, round3_right.t__title, round3_left.mc__company_type_id;

CREATE OR REPLACE TEMP VIEW ya_11d_rewriteYa33_r3_join_7 AS
SELECT round3_right.cn__name AS cn__name,
       round3_right.mc__note AS mc__note,
       round3_right.t__title AS t__title,
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_11d_rewriteYa33_r3_base_ct AS round3_left
JOIN ya_11d_rewriteYa33_r3_join_6 AS round3_right
  ON (round3_right.mc__company_type_id = round3_left.ct__id)
GROUP BY round3_right.cn__name, round3_right.mc__note, round3_right.t__title;
...
FROM ya_11d_rewriteYa33_r3_join_7 AS round3_result;
