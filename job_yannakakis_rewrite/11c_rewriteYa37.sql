...
FROM ya_11c_rewriteYa37_down_cn AS cn,
     ya_11c_rewriteYa37_down_ct AS ct,
     ya_11c_rewriteYa37_down_k AS k,
     ya_11c_rewriteYa37_down_lt AS lt,
     ya_11c_rewriteYa37_down_mc AS mc,
     ya_11c_rewriteYa37_down_mk AS mk,
     ya_11c_rewriteYa37_down_ml AS ml,
     ya_11c_rewriteYa37_down_t AS t
WHERE (cn.country_code !='[pl]')
  AND ((cn.name LIKE '20th Century Fox%'
       OR cn.name LIKE 'Twentieth Century Fox%'))
