...
FROM ya_16c_rewriteYa47_down_an AS an,
     ya_16c_rewriteYa47_down_ci AS ci,
     ya_16c_rewriteYa47_down_cn AS cn,
     ya_16c_rewriteYa47_down_k AS k,
     ya_16c_rewriteYa47_down_mc AS mc,
     ya_16c_rewriteYa47_down_mk AS mk,
     ya_16c_rewriteYa47_down_n AS n,
     ya_16c_rewriteYa47_down_t AS t
WHERE (cn.country_code ='[us]')
