...
FROM ya_23c_rewriteYa351_down_cc AS cc,
     ya_23c_rewriteYa351_down_cct1 AS cct1,
     ya_23c_rewriteYa351_down_cn AS cn,
     ya_23c_rewriteYa351_down_ct AS ct,
     ya_23c_rewriteYa351_down_it1 AS it1,
     ya_23c_rewriteYa351_down_k AS k,
     ya_23c_rewriteYa351_down_kt AS kt,
     ya_23c_rewriteYa351_down_mc AS mc,
     ya_23c_rewriteYa351_down_mi AS mi,
     ya_23c_rewriteYa351_down_mk AS mk,
     ya_23c_rewriteYa351_down_t AS t
WHERE (cct1.kind = 'complete+verified')
