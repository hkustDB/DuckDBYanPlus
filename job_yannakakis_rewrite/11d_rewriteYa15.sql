...
FROM ya_11d_rewriteYa15_down_cn AS cn,
     ya_11d_rewriteYa15_down_ct AS ct,
     ya_11d_rewriteYa15_down_k AS k,
     ya_11d_rewriteYa15_down_lt AS lt,
     ya_11d_rewriteYa15_down_mc AS mc,
     ya_11d_rewriteYa15_down_mk AS mk,
     ya_11d_rewriteYa15_down_ml AS ml,
     ya_11d_rewriteYa15_down_t AS t
WHERE (cn.country_code !='[pl]')
