...
FROM ya_8a_rewriteYa6_down_an1 AS an1,
     ya_8a_rewriteYa6_down_ci AS ci,
     ya_8a_rewriteYa6_down_cn AS cn,
     ya_8a_rewriteYa6_down_mc AS mc,
     ya_8a_rewriteYa6_down_n1 AS n1,
     ya_8a_rewriteYa6_down_rt AS rt,
     ya_8a_rewriteYa6_down_t AS t
WHERE (ci.note ='(voice: English version)')
