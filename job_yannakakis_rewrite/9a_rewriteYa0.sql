...
FROM ya_9a_rewriteYa0_down_an AS an,
     ya_9a_rewriteYa0_down_chn AS chn,
     ya_9a_rewriteYa0_down_ci AS ci,
     ya_9a_rewriteYa0_down_cn AS cn,
     ya_9a_rewriteYa0_down_mc AS mc,
     ya_9a_rewriteYa0_down_n AS n,
     ya_9a_rewriteYa0_down_rt AS rt,
     ya_9a_rewriteYa0_down_t AS t
WHERE (ci.note IN ('(voice)',
                  '(voice: Japanese version)',
                  '(voice) (uncredited)',
                  '(voice: English version)'))
