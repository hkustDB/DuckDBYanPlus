...
FROM ya_12c_rewriteYa25_down_cn AS cn,
     ya_12c_rewriteYa25_down_ct AS ct,
     ya_12c_rewriteYa25_down_it1 AS it1,
     ya_12c_rewriteYa25_down_it2 AS it2,
     ya_12c_rewriteYa25_down_mc AS mc,
     ya_12c_rewriteYa25_down_mi AS mi,
     ya_12c_rewriteYa25_down_mi_idx AS mi_idx,
     ya_12c_rewriteYa25_down_t AS t
WHERE (cn.country_code = '[us]')
