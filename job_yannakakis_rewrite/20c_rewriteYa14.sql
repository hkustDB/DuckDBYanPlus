...
FROM ya_20c_rewriteYa14_down_cc AS cc,
     ya_20c_rewriteYa14_down_cct1 AS cct1,
     ya_20c_rewriteYa14_down_cct2 AS cct2,
     ya_20c_rewriteYa14_down_chn AS chn,
     ya_20c_rewriteYa14_down_ci AS ci,
     ya_20c_rewriteYa14_down_k AS k,
     ya_20c_rewriteYa14_down_kt AS kt,
     ya_20c_rewriteYa14_down_mk AS mk,
     ya_20c_rewriteYa14_down_n AS n,
     ya_20c_rewriteYa14_down_t AS t
WHERE (cct1.kind = 'cast')
