...
FROM ya_14b_rewriteYa31_down_it1 AS it1,
     ya_14b_rewriteYa31_down_it2 AS it2,
     ya_14b_rewriteYa31_down_k AS k,
     ya_14b_rewriteYa31_down_kt AS kt,
     ya_14b_rewriteYa31_down_mi AS mi,
     ya_14b_rewriteYa31_down_mi_idx AS mi_idx,
     ya_14b_rewriteYa31_down_mk AS mk,
     ya_14b_rewriteYa31_down_t AS t
WHERE (it1.info = 'countries')
  AND (it2.info = 'rating')
