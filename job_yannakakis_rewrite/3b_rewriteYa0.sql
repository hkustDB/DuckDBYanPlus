...
CREATE OR REPLACE TEMP VIEW ya_3b_rewriteYa0_r3_base_k AS
SELECT k.id AS k__id,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_3b_rewriteYa0_down_k AS k
GROUP BY k.id;

CREATE OR REPLACE TEMP VIEW ya_3b_rewriteYa0_r3_base_mi AS
SELECT mi.movie_id AS mi__movie_id,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_3b_rewriteYa0_down_mi AS mi
GROUP BY mi.movie_id;

CREATE OR REPLACE TEMP VIEW ya_3b_rewriteYa0_r3_base_mk AS
SELECT mk.movie_id AS mk__movie_id,
       mk.keyword_id AS mk__keyword_id,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_3b_rewriteYa0_down_mk AS mk
GROUP BY mk.movie_id, mk.keyword_id;

CREATE OR REPLACE TEMP VIEW ya_3b_rewriteYa0_r3_base_t AS
SELECT t.id AS t__id,
       t.title AS t__title,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_3b_rewriteYa0_down_t AS t
GROUP BY t.id, t.title;

CREATE OR REPLACE TEMP VIEW ya_3b_rewriteYa0_r3_join_1 AS
...
FROM ya_3b_rewriteYa0_r3_base_mk AS round3_left
JOIN ya_3b_rewriteYa0_r3_base_t AS round3_right
...
CREATE OR REPLACE TEMP VIEW ya_3b_rewriteYa0_r3_join_2 AS
SELECT round3_left.t__title AS t__title,
       round3_left.mk__keyword_id AS mk__keyword_id,
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_3b_rewriteYa0_r3_join_1 AS round3_left
JOIN ya_3b_rewriteYa0_r3_base_mi AS round3_right
...
CREATE OR REPLACE TEMP VIEW ya_3b_rewriteYa0_r3_join_3 AS
SELECT round3_right.t__title AS t__title,
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_3b_rewriteYa0_r3_base_k AS round3_left
JOIN ya_3b_rewriteYa0_r3_join_2 AS round3_right
...
FROM ya_3b_rewriteYa0_r3_join_3 AS round3_result;
