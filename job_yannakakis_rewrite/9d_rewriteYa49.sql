...
CREATE OR REPLACE TEMP VIEW ya_9d_rewriteYa49_r3_base_an AS
...
CREATE OR REPLACE TEMP VIEW ya_9d_rewriteYa49_r3_base_chn AS
SELECT chn.id AS chn__id,
       chn.name AS chn__name,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_9d_rewriteYa49_down_chn AS chn
GROUP BY chn.id, chn.name;

CREATE OR REPLACE TEMP VIEW ya_9d_rewriteYa49_r3_base_ci AS
SELECT ci.movie_id AS ci__movie_id,
       ...
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_9d_rewriteYa49_down_ci AS ci
GROUP BY ci.movie_id, ci.role_id, ci.person_id, ci.person_role_id;

CREATE OR REPLACE TEMP VIEW ya_9d_rewriteYa49_r3_base_cn AS
SELECT cn.id AS cn__id,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_9d_rewriteYa49_down_cn AS cn
GROUP BY cn.id;

CREATE OR REPLACE TEMP VIEW ya_9d_rewriteYa49_r3_base_mc AS
SELECT mc.movie_id AS mc__movie_id,
       mc.company_id AS mc__company_id,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_9d_rewriteYa49_down_mc AS mc
GROUP BY mc.movie_id, mc.company_id;

CREATE OR REPLACE TEMP VIEW ya_9d_rewriteYa49_r3_base_n AS
SELECT n.id AS n__id,
       n.name AS n__name,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_9d_rewriteYa49_down_n AS n
GROUP BY n.id, n.name;

CREATE OR REPLACE TEMP VIEW ya_9d_rewriteYa49_r3_base_rt AS
SELECT rt.id AS rt__id,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_9d_rewriteYa49_down_rt AS rt
GROUP BY rt.id;

CREATE OR REPLACE TEMP VIEW ya_9d_rewriteYa49_r3_base_t AS
SELECT t.id AS t__id,
       t.title AS t__title,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_9d_rewriteYa49_down_t AS t
GROUP BY t.id, t.title;

CREATE OR REPLACE TEMP VIEW ya_9d_rewriteYa49_r3_join_1 AS
...
FROM ya_9d_rewriteYa49_r3_base_ci AS round3_left
JOIN ya_9d_rewriteYa49_r3_base_n AS round3_right
...
CREATE OR REPLACE TEMP VIEW ya_9d_rewriteYa49_r3_join_2 AS
SELECT round3_left.n__name AS n__name,
       ...
       round3_left.ci__person_id AS ci__person_id,
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_9d_rewriteYa49_r3_join_1 AS round3_left
JOIN ya_9d_rewriteYa49_r3_base_rt AS round3_right
...
CREATE OR REPLACE TEMP VIEW ya_9d_rewriteYa49_r3_join_3 AS
SELECT round3_left.n__name AS n__name,
       ...
       round3_left.ci__person_id AS ci__person_id,
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_9d_rewriteYa49_r3_join_2 AS round3_left
JOIN ya_9d_rewriteYa49_r3_base_t AS round3_right
...
CREATE OR REPLACE TEMP VIEW ya_9d_rewriteYa49_r3_join_4 AS
SELECT round3_right.an__name AS an__name,
       ...
       round3_left.ci__person_role_id AS ci__person_role_id,
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_9d_rewriteYa49_r3_join_3 AS round3_left
JOIN ya_9d_rewriteYa49_r3_base_an AS round3_right
...
CREATE OR REPLACE TEMP VIEW ya_9d_rewriteYa49_r3_join_5 AS
SELECT round3_left.mc__movie_id AS mc__movie_id,
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_9d_rewriteYa49_r3_base_mc AS round3_left
JOIN ya_9d_rewriteYa49_r3_base_cn AS round3_right
  ON (round3_left.mc__company_id = round3_right.cn__id)
GROUP BY round3_left.mc__movie_id;

CREATE OR REPLACE TEMP VIEW ya_9d_rewriteYa49_r3_join_6 AS
SELECT round3_left.an__name AS an__name,
       round3_left.n__name AS n__name,
       round3_left.t__title AS t__title,
       round3_left.ci__person_role_id AS ci__person_role_id,
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_9d_rewriteYa49_r3_join_4 AS round3_left
JOIN ya_9d_rewriteYa49_r3_join_5 AS round3_right
...
CREATE OR REPLACE TEMP VIEW ya_9d_rewriteYa49_r3_join_7 AS
SELECT round3_right.an__name AS an__name,
       round3_left.chn__name AS chn__name,
       round3_right.n__name AS n__name,
       round3_right.t__title AS t__title,
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_9d_rewriteYa49_r3_base_chn AS round3_left
JOIN ya_9d_rewriteYa49_r3_join_6 AS round3_right
...
FROM ya_9d_rewriteYa49_r3_join_7 AS round3_result;
