...
FROM ya_10c_rewriteYa8_down_chn AS chn,
     ya_10c_rewriteYa8_down_ci AS ci,
     ya_10c_rewriteYa8_down_cn AS cn,
     ya_10c_rewriteYa8_down_ct AS ct,
     ya_10c_rewriteYa8_down_mc AS mc,
     ya_10c_rewriteYa8_down_rt AS rt,
     ya_10c_rewriteYa8_down_t AS t
WHERE (ci.note LIKE '%(producer)%')
