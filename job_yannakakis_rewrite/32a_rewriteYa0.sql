...
FROM ya_32a_rewriteYa0_down_k AS k,
     ya_32a_rewriteYa0_down_lt AS lt,
     ya_32a_rewriteYa0_down_mk AS mk,
     ya_32a_rewriteYa0_down_ml AS ml,
     ya_32a_rewriteYa0_down_t1 AS t1,
     ya_32a_rewriteYa0_down_t2 AS t2
WHERE (k.keyword ='10,000-mile-club')
