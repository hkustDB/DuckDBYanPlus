...
FROM ya_24b_rewriteYa0_down_an AS an,
     ya_24b_rewriteYa0_down_chn AS chn,
     ya_24b_rewriteYa0_down_ci AS ci,
     ya_24b_rewriteYa0_down_cn AS cn,
     ya_24b_rewriteYa0_down_it AS it,
     ya_24b_rewriteYa0_down_k AS k,
     ya_24b_rewriteYa0_down_mc AS mc,
     ya_24b_rewriteYa0_down_mi AS mi,
     ya_24b_rewriteYa0_down_mk AS mk,
     ya_24b_rewriteYa0_down_n AS n,
     ya_24b_rewriteYa0_down_rt AS rt,
     ya_24b_rewriteYa0_down_t AS t
WHERE (ci.note IN ('(voice)',
                  '(voice: Japanese version)',
                  '(voice) (uncredited)',
                  '(voice: English version)'))
