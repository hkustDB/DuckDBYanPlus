...
CREATE OR REPLACE TEMP VIEW ya_7c_rewriteYa95_r3_base_an AS
...
CREATE OR REPLACE TEMP VIEW ya_7c_rewriteYa95_r3_base_ci AS
SELECT ci.person_id AS ci__person_id,
       ci.movie_id AS ci__movie_id,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_7c_rewriteYa95_down_ci AS ci
GROUP BY ci.person_id, ci.movie_id;

CREATE OR REPLACE TEMP VIEW ya_7c_rewriteYa95_r3_base_it AS
SELECT it.id AS it__id,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_7c_rewriteYa95_down_it AS it
GROUP BY it.id;

CREATE OR REPLACE TEMP VIEW ya_7c_rewriteYa95_r3_base_lt AS
SELECT lt.id AS lt__id,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_7c_rewriteYa95_down_lt AS lt
GROUP BY lt.id;

CREATE OR REPLACE TEMP VIEW ya_7c_rewriteYa95_r3_base_ml AS
SELECT ml.linked_movie_id AS ml__linked_movie_id,
       ml.link_type_id AS ml__link_type_id,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_7c_rewriteYa95_down_ml AS ml
GROUP BY ml.linked_movie_id, ml.link_type_id;

CREATE OR REPLACE TEMP VIEW ya_7c_rewriteYa95_r3_base_n AS
SELECT n.id AS n__id,
       n.name AS n__name,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_7c_rewriteYa95_down_n AS n
GROUP BY n.id, n.name;

CREATE OR REPLACE TEMP VIEW ya_7c_rewriteYa95_r3_base_pi AS
SELECT pi.person_id AS pi__person_id,
       pi.info_type_id AS pi__info_type_id,
       pi.info AS pi__info,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_7c_rewriteYa95_down_pi AS pi
GROUP BY pi.person_id, pi.info_type_id, pi.info;

CREATE OR REPLACE TEMP VIEW ya_7c_rewriteYa95_r3_base_t AS
SELECT t.id AS t__id,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_7c_rewriteYa95_down_t AS t
GROUP BY t.id;

CREATE OR REPLACE TEMP VIEW ya_7c_rewriteYa95_r3_join_1 AS
...
FROM ya_7c_rewriteYa95_r3_base_pi AS round3_left
JOIN ya_7c_rewriteYa95_r3_base_it AS round3_right
  ON (round3_right.it__id = round3_left.pi__info_type_id)
GROUP BY round3_left.pi__info, round3_left.pi__person_id;

CREATE OR REPLACE TEMP VIEW ya_7c_rewriteYa95_r3_join_2 AS
SELECT round3_right.pi__info AS pi__info,
       ...
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_7c_rewriteYa95_r3_base_ci AS round3_left
JOIN ya_7c_rewriteYa95_r3_join_1 AS round3_right
  ON (round3_right.pi__person_id = round3_left.ci__person_id)
GROUP BY round3_right.pi__info, round3_right.pi__person_id, round3_left.ci__person_id, round3_left.ci__movie_id;

CREATE OR REPLACE TEMP VIEW ya_7c_rewriteYa95_r3_join_3 AS
SELECT round3_left.pi__info AS pi__info,
       ...
       round3_left.ci__movie_id AS ci__movie_id,
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_7c_rewriteYa95_r3_join_2 AS round3_left
JOIN ya_7c_rewriteYa95_r3_base_an AS round3_right
  ON (round3_left.pi__person_id = round3_right.an__person_id)
 AND (round3_right.an__person_id = round3_left.ci__person_id)
GROUP BY round3_left.pi__info, round3_right.an__person_id, round3_left.pi__person_id, round3_left.ci__person_id, round3_left.ci__movie_id;

CREATE OR REPLACE TEMP VIEW ya_7c_rewriteYa95_r3_join_4 AS
SELECT round3_right.n__name AS n__name,
       round3_left.pi__info AS pi__info,
       round3_left.ci__movie_id AS ci__movie_id,
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_7c_rewriteYa95_r3_join_3 AS round3_left
JOIN ya_7c_rewriteYa95_r3_base_n AS round3_right
  ON (round3_right.n__id = round3_left.an__person_id)
 AND (round3_right.n__id = round3_left.pi__person_id)
 AND (round3_left.ci__person_id = round3_right.n__id)
GROUP BY round3_right.n__name, round3_left.pi__info, round3_left.ci__movie_id;

CREATE OR REPLACE TEMP VIEW ya_7c_rewriteYa95_r3_join_5 AS
SELECT round3_right.n__name AS n__name,
       round3_right.pi__info AS pi__info,
       round3_left.t__id AS t__id,
       round3_right.ci__movie_id AS ci__movie_id,
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_7c_rewriteYa95_r3_base_t AS round3_left
JOIN ya_7c_rewriteYa95_r3_join_4 AS round3_right
...
CREATE OR REPLACE TEMP VIEW ya_7c_rewriteYa95_r3_join_6 AS
SELECT round3_left.ml__linked_movie_id AS ml__linked_movie_id,
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_7c_rewriteYa95_r3_base_ml AS round3_left
JOIN ya_7c_rewriteYa95_r3_base_lt AS round3_right
  ON (round3_right.lt__id = round3_left.ml__link_type_id)
GROUP BY round3_left.ml__linked_movie_id;

CREATE OR REPLACE TEMP VIEW ya_7c_rewriteYa95_r3_join_7 AS
SELECT round3_left.n__name AS n__name,
       round3_left.pi__info AS pi__info,
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_7c_rewriteYa95_r3_join_5 AS round3_left
JOIN ya_7c_rewriteYa95_r3_join_6 AS round3_right
...
FROM ya_7c_rewriteYa95_r3_join_7 AS round3_result;
