...
FROM ya_11a_rewriteYa0_down_cn AS cn,
     ya_11a_rewriteYa0_down_ct AS ct,
     ya_11a_rewriteYa0_down_k AS k,
     ya_11a_rewriteYa0_down_lt AS lt,
     ya_11a_rewriteYa0_down_mc AS mc,
     ya_11a_rewriteYa0_down_mk AS mk,
     ya_11a_rewriteYa0_down_ml AS ml,
     ya_11a_rewriteYa0_down_t AS t
WHERE (cn.country_code !='[pl]')
  AND ((cn.name LIKE '%Film%'
       OR cn.name LIKE '%Warner%'))
