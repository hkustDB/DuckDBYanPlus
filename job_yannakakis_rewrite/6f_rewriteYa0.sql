...
CREATE OR REPLACE TEMP VIEW ya_6f_rewriteYa0_r3_base_ci AS
...
CREATE OR REPLACE TEMP VIEW ya_6f_rewriteYa0_r3_base_k AS
SELECT k.id AS k__id,
       k.keyword AS k__keyword,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_6f_rewriteYa0_down_k AS k
GROUP BY k.id, k.keyword;

CREATE OR REPLACE TEMP VIEW ya_6f_rewriteYa0_r3_base_mk AS
SELECT mk.keyword_id AS mk__keyword_id,
       mk.movie_id AS mk__movie_id,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_6f_rewriteYa0_down_mk AS mk
GROUP BY mk.keyword_id, mk.movie_id;

CREATE OR REPLACE TEMP VIEW ya_6f_rewriteYa0_r3_base_n AS
SELECT n.id AS n__id,
       n.name AS n__name,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_6f_rewriteYa0_down_n AS n
GROUP BY n.id, n.name;

CREATE OR REPLACE TEMP VIEW ya_6f_rewriteYa0_r3_base_t AS
SELECT t.id AS t__id,
       t.title AS t__title,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_6f_rewriteYa0_down_t AS t
GROUP BY t.id, t.title;

CREATE OR REPLACE TEMP VIEW ya_6f_rewriteYa0_r3_join_1 AS
...
FROM ya_6f_rewriteYa0_r3_base_ci AS round3_left
JOIN ya_6f_rewriteYa0_r3_base_n AS round3_right
  ON (round3_right.n__id = round3_left.ci__person_id)
GROUP BY round3_right.n__name, round3_left.ci__movie_id;

CREATE OR REPLACE TEMP VIEW ya_6f_rewriteYa0_r3_join_2 AS
SELECT round3_left.n__name AS n__name,
       round3_right.t__title AS t__title,
       round3_right.t__id AS t__id,
       round3_left.ci__movie_id AS ci__movie_id,
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_6f_rewriteYa0_r3_join_1 AS round3_left
JOIN ya_6f_rewriteYa0_r3_base_t AS round3_right
...
CREATE OR REPLACE TEMP VIEW ya_6f_rewriteYa0_r3_join_3 AS
SELECT round3_right.k__keyword AS k__keyword,
       round3_left.mk__movie_id AS mk__movie_id,
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_6f_rewriteYa0_r3_base_mk AS round3_left
JOIN ya_6f_rewriteYa0_r3_base_k AS round3_right
  ON (round3_right.k__id = round3_left.mk__keyword_id)
GROUP BY round3_right.k__keyword, round3_left.mk__movie_id;

CREATE OR REPLACE TEMP VIEW ya_6f_rewriteYa0_r3_join_4 AS
SELECT round3_right.k__keyword AS k__keyword,
       round3_left.n__name AS n__name,
       round3_left.t__title AS t__title,
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_6f_rewriteYa0_r3_join_2 AS round3_left
JOIN ya_6f_rewriteYa0_r3_join_3 AS round3_right
...
FROM ya_6f_rewriteYa0_r3_join_4 AS round3_result;
