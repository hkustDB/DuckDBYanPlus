...
CREATE OR REPLACE TEMP VIEW ya_8b_rewriteYa10_r3_base_an AS
...
CREATE OR REPLACE TEMP VIEW ya_8b_rewriteYa10_r3_base_ci AS
SELECT ci.person_id AS ci__person_id,
       ci.movie_id AS ci__movie_id,
       ci.role_id AS ci__role_id,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_8b_rewriteYa10_down_ci AS ci
GROUP BY ci.person_id, ci.movie_id, ci.role_id;

CREATE OR REPLACE TEMP VIEW ya_8b_rewriteYa10_r3_base_cn AS
SELECT cn.id AS cn__id,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_8b_rewriteYa10_down_cn AS cn
GROUP BY cn.id;

CREATE OR REPLACE TEMP VIEW ya_8b_rewriteYa10_r3_base_mc AS
SELECT mc.movie_id AS mc__movie_id,
       mc.company_id AS mc__company_id,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_8b_rewriteYa10_down_mc AS mc
GROUP BY mc.movie_id, mc.company_id;

CREATE OR REPLACE TEMP VIEW ya_8b_rewriteYa10_r3_base_n AS
SELECT n.id AS n__id,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_8b_rewriteYa10_down_n AS n
GROUP BY n.id;

CREATE OR REPLACE TEMP VIEW ya_8b_rewriteYa10_r3_base_rt AS
SELECT rt.id AS rt__id,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_8b_rewriteYa10_down_rt AS rt
GROUP BY rt.id;

CREATE OR REPLACE TEMP VIEW ya_8b_rewriteYa10_r3_base_t AS
SELECT t.id AS t__id,
       t.title AS t__title,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_8b_rewriteYa10_down_t AS t
GROUP BY t.id, t.title;

CREATE OR REPLACE TEMP VIEW ya_8b_rewriteYa10_r3_join_1 AS
...
FROM ya_8b_rewriteYa10_r3_base_mc AS round3_left
JOIN ya_8b_rewriteYa10_r3_base_t AS round3_right
...
CREATE OR REPLACE TEMP VIEW ya_8b_rewriteYa10_r3_join_2 AS
SELECT round3_right.an__name AS an__name,
       ...
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_8b_rewriteYa10_r3_base_ci AS round3_left
JOIN ya_8b_rewriteYa10_r3_base_an AS round3_right
  ON (round3_right.an__person_id = round3_left.ci__person_id)
GROUP BY round3_right.an__name, round3_right.an__person_id, round3_left.ci__person_id, round3_left.ci__movie_id, round3_left.ci__role_id;

CREATE OR REPLACE TEMP VIEW ya_8b_rewriteYa10_r3_join_3 AS
SELECT round3_left.an__name AS an__name,
       round3_left.ci__movie_id AS ci__movie_id,
       round3_left.ci__role_id AS ci__role_id,
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_8b_rewriteYa10_r3_join_2 AS round3_left
JOIN ya_8b_rewriteYa10_r3_base_n AS round3_right
  ON (round3_left.an__person_id = round3_right.n__id)
 AND (round3_right.n__id = round3_left.ci__person_id)
GROUP BY round3_left.an__name, round3_left.ci__movie_id, round3_left.ci__role_id;

CREATE OR REPLACE TEMP VIEW ya_8b_rewriteYa10_r3_join_4 AS
SELECT round3_left.an__name AS an__name,
       round3_left.ci__movie_id AS ci__movie_id,
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_8b_rewriteYa10_r3_join_3 AS round3_left
JOIN ya_8b_rewriteYa10_r3_base_rt AS round3_right
  ON (round3_left.ci__role_id = round3_right.rt__id)
GROUP BY round3_left.an__name, round3_left.ci__movie_id;

CREATE OR REPLACE TEMP VIEW ya_8b_rewriteYa10_r3_join_5 AS
SELECT round3_right.an__name AS an__name,
       round3_left.t__title AS t__title,
       round3_left.mc__company_id AS mc__company_id,
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_8b_rewriteYa10_r3_join_1 AS round3_left
JOIN ya_8b_rewriteYa10_r3_join_4 AS round3_right
  ON (round3_right.ci__movie_id = round3_left.t__id)
 AND (round3_right.ci__movie_id = round3_left.mc__movie_id)
GROUP BY round3_right.an__name, round3_left.t__title, round3_left.mc__company_id;

CREATE OR REPLACE TEMP VIEW ya_8b_rewriteYa10_r3_join_6 AS
SELECT round3_left.an__name AS an__name,
       round3_left.t__title AS t__title,
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_8b_rewriteYa10_r3_join_5 AS round3_left
JOIN ya_8b_rewriteYa10_r3_base_cn AS round3_right
...
FROM ya_8b_rewriteYa10_r3_join_6 AS round3_result;
