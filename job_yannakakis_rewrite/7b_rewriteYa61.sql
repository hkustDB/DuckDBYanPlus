...
FROM ya_7b_rewriteYa61_down_an AS an,
     ya_7b_rewriteYa61_down_ci AS ci,
     ya_7b_rewriteYa61_down_it AS it,
     ya_7b_rewriteYa61_down_lt AS lt,
     ya_7b_rewriteYa61_down_ml AS ml,
     ya_7b_rewriteYa61_down_n AS n,
     ya_7b_rewriteYa61_down_pi AS pi,
     ya_7b_rewriteYa61_down_t AS t
WHERE (an.name LIKE '%a%')
