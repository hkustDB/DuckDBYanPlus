...
FROM ya_29b_rewriteYa0_down_an AS an,
     ya_29b_rewriteYa0_down_cc AS cc,
     ya_29b_rewriteYa0_down_cct1 AS cct1,
     ya_29b_rewriteYa0_down_cct2 AS cct2,
     ya_29b_rewriteYa0_down_chn AS chn,
     ya_29b_rewriteYa0_down_ci AS ci,
     ya_29b_rewriteYa0_down_cn AS cn,
     ya_29b_rewriteYa0_down_it AS it,
     ya_29b_rewriteYa0_down_it3 AS it3,
     ya_29b_rewriteYa0_down_k AS k,
     ya_29b_rewriteYa0_down_mc AS mc,
     ya_29b_rewriteYa0_down_mi AS mi,
     ya_29b_rewriteYa0_down_mk AS mk,
     ya_29b_rewriteYa0_down_n AS n,
     ya_29b_rewriteYa0_down_pi AS pi,
     ya_29b_rewriteYa0_down_rt AS rt,
     ya_29b_rewriteYa0_down_t AS t
WHERE (cct1.kind ='cast')
