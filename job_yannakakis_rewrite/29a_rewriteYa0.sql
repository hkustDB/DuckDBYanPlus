...
CREATE OR REPLACE TEMP VIEW ya_29a_rewriteYa0_r3_base_an AS
...
CREATE OR REPLACE TEMP VIEW ya_29a_rewriteYa0_r3_base_cc AS
SELECT cc.movie_id AS cc__movie_id,
       cc.subject_id AS cc__subject_id,
       cc.status_id AS cc__status_id,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_29a_rewriteYa0_down_cc AS cc
GROUP BY cc.movie_id, cc.subject_id, cc.status_id;

CREATE OR REPLACE TEMP VIEW ya_29a_rewriteYa0_r3_base_cct1 AS
SELECT cct1.id AS cct1__id,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_29a_rewriteYa0_down_cct1 AS cct1
GROUP BY cct1.id;

CREATE OR REPLACE TEMP VIEW ya_29a_rewriteYa0_r3_base_cct2 AS
SELECT cct2.id AS cct2__id,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_29a_rewriteYa0_down_cct2 AS cct2
GROUP BY cct2.id;

CREATE OR REPLACE TEMP VIEW ya_29a_rewriteYa0_r3_base_chn AS
SELECT chn.id AS chn__id,
       chn.name AS chn__name,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_29a_rewriteYa0_down_chn AS chn
GROUP BY chn.id, chn.name;

CREATE OR REPLACE TEMP VIEW ya_29a_rewriteYa0_r3_base_ci AS
SELECT ci.movie_id AS ci__movie_id,
       ...
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_29a_rewriteYa0_down_ci AS ci
GROUP BY ci.movie_id, ci.person_id, ci.role_id, ci.person_role_id;

CREATE OR REPLACE TEMP VIEW ya_29a_rewriteYa0_r3_base_cn AS
SELECT cn.id AS cn__id,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_29a_rewriteYa0_down_cn AS cn
GROUP BY cn.id;

CREATE OR REPLACE TEMP VIEW ya_29a_rewriteYa0_r3_base_it AS
SELECT it.id AS it__id,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_29a_rewriteYa0_down_it AS it
GROUP BY it.id;

CREATE OR REPLACE TEMP VIEW ya_29a_rewriteYa0_r3_base_it3 AS
SELECT it3.id AS it3__id,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_29a_rewriteYa0_down_it3 AS it3
GROUP BY it3.id;

CREATE OR REPLACE TEMP VIEW ya_29a_rewriteYa0_r3_base_k AS
SELECT k.id AS k__id,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_29a_rewriteYa0_down_k AS k
GROUP BY k.id;

CREATE OR REPLACE TEMP VIEW ya_29a_rewriteYa0_r3_base_mc AS
SELECT mc.movie_id AS mc__movie_id,
       mc.company_id AS mc__company_id,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_29a_rewriteYa0_down_mc AS mc
GROUP BY mc.movie_id, mc.company_id;

CREATE OR REPLACE TEMP VIEW ya_29a_rewriteYa0_r3_base_mi AS
SELECT mi.movie_id AS mi__movie_id,
       mi.info_type_id AS mi__info_type_id,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_29a_rewriteYa0_down_mi AS mi
GROUP BY mi.movie_id, mi.info_type_id;

CREATE OR REPLACE TEMP VIEW ya_29a_rewriteYa0_r3_base_mk AS
SELECT mk.movie_id AS mk__movie_id,
       mk.keyword_id AS mk__keyword_id,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_29a_rewriteYa0_down_mk AS mk
GROUP BY mk.movie_id, mk.keyword_id;

CREATE OR REPLACE TEMP VIEW ya_29a_rewriteYa0_r3_base_n AS
SELECT n.id AS n__id,
       n.name AS n__name,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_29a_rewriteYa0_down_n AS n
GROUP BY n.id, n.name;

CREATE OR REPLACE TEMP VIEW ya_29a_rewriteYa0_r3_base_pi AS
SELECT pi.person_id AS pi__person_id,
       pi.info_type_id AS pi__info_type_id,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_29a_rewriteYa0_down_pi AS pi
GROUP BY pi.person_id, pi.info_type_id;

CREATE OR REPLACE TEMP VIEW ya_29a_rewriteYa0_r3_base_rt AS
SELECT rt.id AS rt__id,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_29a_rewriteYa0_down_rt AS rt
GROUP BY rt.id;

CREATE OR REPLACE TEMP VIEW ya_29a_rewriteYa0_r3_base_t AS
SELECT t.id AS t__id,
       t.title AS t__title,
       CAST(COUNT(*) AS HUGEINT) AS annot
FROM ya_29a_rewriteYa0_down_t AS t
GROUP BY t.id, t.title;

CREATE OR REPLACE TEMP VIEW ya_29a_rewriteYa0_r3_join_1 AS
SELECT round3_left.pi__person_id AS pi__person_id,
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_29a_rewriteYa0_r3_base_pi AS round3_left
JOIN ya_29a_rewriteYa0_r3_base_it3 AS round3_right
  ON (round3_right.it3__id = round3_left.pi__info_type_id)
GROUP BY round3_left.pi__person_id;

CREATE OR REPLACE TEMP VIEW ya_29a_rewriteYa0_r3_join_2 AS
SELECT round3_left.n__name AS n__name,
       round3_left.n__id AS n__id,
       round3_right.pi__person_id AS pi__person_id,
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_29a_rewriteYa0_r3_base_n AS round3_left
JOIN ya_29a_rewriteYa0_r3_join_1 AS round3_right
  ON (round3_left.n__id = round3_right.pi__person_id)
GROUP BY round3_left.n__name, round3_left.n__id, round3_right.pi__person_id;

CREATE OR REPLACE TEMP VIEW ya_29a_rewriteYa0_r3_join_3 AS
SELECT round3_right.n__name AS n__name,
       round3_right.n__id AS n__id,
       round3_left.an__person_id AS an__person_id,
       round3_right.pi__person_id AS pi__person_id,
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_29a_rewriteYa0_r3_base_an AS round3_left
JOIN ya_29a_rewriteYa0_r3_join_2 AS round3_right
...
CREATE OR REPLACE TEMP VIEW ya_29a_rewriteYa0_r3_join_4 AS
SELECT round3_left.mi__movie_id AS mi__movie_id,
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_29a_rewriteYa0_r3_base_mi AS round3_left
JOIN ya_29a_rewriteYa0_r3_base_it AS round3_right
  ON (round3_right.it__id = round3_left.mi__info_type_id)
GROUP BY round3_left.mi__movie_id;

CREATE OR REPLACE TEMP VIEW ya_29a_rewriteYa0_r3_join_5 AS
SELECT round3_right.mi__movie_id AS mi__movie_id,
       ...
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_29a_rewriteYa0_r3_base_ci AS round3_left
JOIN ya_29a_rewriteYa0_r3_join_4 AS round3_right
...
CREATE OR REPLACE TEMP VIEW ya_29a_rewriteYa0_r3_join_6 AS
SELECT round3_left.mk__movie_id AS mk__movie_id,
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_29a_rewriteYa0_r3_base_mk AS round3_left
JOIN ya_29a_rewriteYa0_r3_base_k AS round3_right
  ON (round3_right.k__id = round3_left.mk__keyword_id)
GROUP BY round3_left.mk__movie_id;

CREATE OR REPLACE TEMP VIEW ya_29a_rewriteYa0_r3_join_7 AS
SELECT round3_left.mi__movie_id AS mi__movie_id,
       round3_left.ci__movie_id AS ci__movie_id,
       ...
       round3_left.ci__person_role_id AS ci__person_role_id,
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_29a_rewriteYa0_r3_join_5 AS round3_left
JOIN ya_29a_rewriteYa0_r3_join_6 AS round3_right
...
CREATE OR REPLACE TEMP VIEW ya_29a_rewriteYa0_r3_join_8 AS
SELECT round3_left.mi__movie_id AS mi__movie_id,
       round3_left.ci__movie_id AS ci__movie_id,
       ...
       round3_left.ci__person_role_id AS ci__person_role_id,
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_29a_rewriteYa0_r3_join_7 AS round3_left
JOIN ya_29a_rewriteYa0_r3_base_rt AS round3_right
...
CREATE OR REPLACE TEMP VIEW ya_29a_rewriteYa0_r3_join_9 AS
SELECT round3_right.t__title AS t__title,
       ...
       round3_left.ci__person_role_id AS ci__person_role_id,
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_29a_rewriteYa0_r3_join_8 AS round3_left
JOIN ya_29a_rewriteYa0_r3_base_t AS round3_right
...
CREATE OR REPLACE TEMP VIEW ya_29a_rewriteYa0_r3_join_10 AS
SELECT round3_left.cc__movie_id AS cc__movie_id,
       round3_left.cc__status_id AS cc__status_id,
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_29a_rewriteYa0_r3_base_cc AS round3_left
JOIN ya_29a_rewriteYa0_r3_base_cct1 AS round3_right
  ON (round3_right.cct1__id = round3_left.cc__subject_id)
GROUP BY round3_left.cc__movie_id, round3_left.cc__status_id;

CREATE OR REPLACE TEMP VIEW ya_29a_rewriteYa0_r3_join_11 AS
SELECT round3_left.cc__movie_id AS cc__movie_id,
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_29a_rewriteYa0_r3_join_10 AS round3_left
JOIN ya_29a_rewriteYa0_r3_base_cct2 AS round3_right
  ON (round3_right.cct2__id = round3_left.cc__status_id)
GROUP BY round3_left.cc__movie_id;

CREATE OR REPLACE TEMP VIEW ya_29a_rewriteYa0_r3_join_12 AS
SELECT round3_left.t__title AS t__title,
       ...
       round3_left.ci__person_role_id AS ci__person_role_id,
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_29a_rewriteYa0_r3_join_9 AS round3_left
JOIN ya_29a_rewriteYa0_r3_join_11 AS round3_right
...
CREATE OR REPLACE TEMP VIEW ya_29a_rewriteYa0_r3_join_13 AS
SELECT round3_right.chn__name AS chn__name,
       ...
       round3_left.ci__person_id AS ci__person_id,
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_29a_rewriteYa0_r3_join_12 AS round3_left
JOIN ya_29a_rewriteYa0_r3_base_chn AS round3_right
...
CREATE OR REPLACE TEMP VIEW ya_29a_rewriteYa0_r3_join_14 AS
SELECT round3_left.mc__movie_id AS mc__movie_id,
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_29a_rewriteYa0_r3_base_mc AS round3_left
JOIN ya_29a_rewriteYa0_r3_base_cn AS round3_right
  ON (round3_right.cn__id = round3_left.mc__company_id)
GROUP BY round3_left.mc__movie_id;

CREATE OR REPLACE TEMP VIEW ya_29a_rewriteYa0_r3_join_15 AS
SELECT round3_left.chn__name AS chn__name,
       round3_left.t__title AS t__title,
       round3_left.ci__person_id AS ci__person_id,
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_29a_rewriteYa0_r3_join_13 AS round3_left
JOIN ya_29a_rewriteYa0_r3_join_14 AS round3_right
...
CREATE OR REPLACE TEMP VIEW ya_29a_rewriteYa0_r3_join_16 AS
SELECT round3_right.chn__name AS chn__name,
       round3_left.n__name AS n__name,
       round3_right.t__title AS t__title,
       SUM(round3_left.annot * round3_right.annot) AS annot
FROM ya_29a_rewriteYa0_r3_join_3 AS round3_left
JOIN ya_29a_rewriteYa0_r3_join_15 AS round3_right
...
FROM ya_29a_rewriteYa0_r3_join_16 AS round3_result;
