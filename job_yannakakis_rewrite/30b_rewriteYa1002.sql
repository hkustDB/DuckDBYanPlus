...
FROM ya_30b_rewriteYa1002_down_cc AS cc,
     ya_30b_rewriteYa1002_down_cct1 AS cct1,
     ya_30b_rewriteYa1002_down_cct2 AS cct2,
     ya_30b_rewriteYa1002_down_ci AS ci,
     ya_30b_rewriteYa1002_down_it1 AS it1,
     ya_30b_rewriteYa1002_down_it2 AS it2,
     ya_30b_rewriteYa1002_down_k AS k,
     ya_30b_rewriteYa1002_down_mi AS mi,
     ya_30b_rewriteYa1002_down_mi_idx AS mi_idx,
     ya_30b_rewriteYa1002_down_mk AS mk,
     ya_30b_rewriteYa1002_down_n AS n,
     ya_30b_rewriteYa1002_down_t AS t
WHERE (cct1.kind IN ('cast',
                    'crew'))
