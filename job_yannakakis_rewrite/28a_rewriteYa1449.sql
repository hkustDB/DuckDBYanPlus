...
FROM ya_28a_rewriteYa1449_down_cc AS cc,
     ya_28a_rewriteYa1449_down_cct1 AS cct1,
     ya_28a_rewriteYa1449_down_cct2 AS cct2,
     ya_28a_rewriteYa1449_down_cn AS cn,
     ya_28a_rewriteYa1449_down_ct AS ct,
     ya_28a_rewriteYa1449_down_it1 AS it1,
     ya_28a_rewriteYa1449_down_it2 AS it2,
     ya_28a_rewriteYa1449_down_k AS k,
     ya_28a_rewriteYa1449_down_kt AS kt,
     ya_28a_rewriteYa1449_down_mc AS mc,
     ya_28a_rewriteYa1449_down_mi AS mi,
     ya_28a_rewriteYa1449_down_mi_idx AS mi_idx,
     ya_28a_rewriteYa1449_down_mk AS mk,
     ya_28a_rewriteYa1449_down_t AS t
WHERE (cct1.kind = 'crew')
